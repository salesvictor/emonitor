...
// Added by Guilherme Leão
String DateTime::dateToString(void) const {
  String _date = "";
  _date.concat((String)(2000 + yOff));
  _date.concat("-");
  _date.concat((String)m);
  _date.concat("-");
  _date.concat((String)d);

  return _date;
}

// Added by Guilherme Leão
String DateTime::timeToString(void) const {
  String _time = "";
  _time.concat((String)hh);
  _time.concat(":");
  _time.concat((String)mm);
  _time.concat(":");
  _time.concat((String)ss);
